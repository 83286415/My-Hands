...
# plot the hyperplane and contour line
...
if __name__ == '__main__':
    ...
    # Gaussian RBF Kernel: SVC rbf kernel trick

    # try different parameters combination like chapter 2 - grid search
    gamma1, gamma2 = 0.1, 5
    C1, C2 = 0.001, 1000
    hyperparams = (gamma1, C1), (gamma1, C2), (gamma2, C1), (gamma2, C2)

    svm_clfs = []  # to save different rbf_clf with different parameters
    ...
    for i, svm_clf in enumerate(svm_clfs):
        ...
        plot_predictions(svm_clf, [-1.5, 2.5, -1, 1.5])  # plot the hyperplane and contour line
        plot_dataset(X, y, [-1.5, 2.5, -1, 1.5])  # plot data set points: blue and green
